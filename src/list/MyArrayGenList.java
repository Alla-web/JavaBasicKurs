 ...
 */
   ...
   // метод должен вернуть наш магический массив в виде обычного массива
    ...
    public T[] toArray() {
        ...
        // из-за стирания типов (T[] result = (T[]) new Object) - программа не знает, что такое тип Т
        // но я могу выяснить на стадии выполнения программы тип объекта из какого-нибудь объекта моего массива
