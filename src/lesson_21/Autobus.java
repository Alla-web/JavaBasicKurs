...
public class Autobus {
     ...
     */
    /*
    АССОЦИАЦИЯ, в т.ч. АГРЕГАЦИЯ и КЛМПОЗИЦИЯ реализуются через создание ссылок
    ...
    КЛМПОЗИЦИЯ между Autobus Autopilot: Autopilot является неотъемлемой частью Autobus и не
    ...
    - кардинальность связи - определяет сколько объектов одного класса может быть ассоциировано
      с объектами другого класса:
        ...
        one to many - автобус и список пассажиро: один автобус может перевозить множество пассажиров
